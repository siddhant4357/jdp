...
const tirthankaras = [
  { id: 1, name: 'जैन स्तुति पाठ', sanskrit: 'Stuti Paath' },
  { id: 2, name: 'विसर्जन पाठ (हिन्दी)', sanskrit: 'Visarjan Paath' },
  { id: 3, name: 'शांतिपाठ', sanskrit: 'Jain Shanti Path' },
  { id: 4, name: 'श्री बाहुबली पूजा', sanskrit: 'Shri Bahubali Swami Pooja' },
  { id: 5, name: 'श्री पंच परमेष्ठी पूजा (णमोकारमंत्रव्रतसहित्)', sanskrit: 'Shri Panch Parmesthi Puja' },
  { id: 6, name: 'णामोकार महामंत्र पूजा', sanskrit: 'Namokar MahaMantra Puja' },
  { id: 7, name: 'नवदेवता जिनपूजा', sanskrit: 'Nav Devta JinPuja' },
  { id: 8, name: 'देव शास्त्र गुरु पूजा – 1', sanskrit: 'Dev Shastra Guru Puja' },
  { id: 9, name: 'समुच्चय पूजा', sanskrit: 'Samuchchay Puja' },
  { id: 10, name: 'श्री देव शास्त्र गुरु पूजा', sanskrit: 'Dev Shastra Guru Pooja' },
  { id: 11, name: 'सिद्धपूजा (भावाष्टक) हीराचंद जी', sanskrit: 'SiddhaPuja Heerachand Ji' },
  { id: 12, name: 'सिद्ध पूजा (भाषा) द्यानतराय', sanskrit: 'Siddha Puja Dyantrai ' },
  { id: 13, name: 'सिद्धपूजा (भावाष्टकम्)', sanskrit: 'SiddhaPuja (Bhavashtakam)' },
  { id: 14, name: 'सिद्धपूजा (द्रव्याष्टकम्)', sanskrit: 'SiddhaPuja (Dravyashtakam)' },
  { id: 15, name: 'देवशास्त्र गुरु पूजन(प्रथम देव अरहंत)', sanskrit: 'Dev Shastra Guru Pujan (Pratham Deva Arihant) ' },
  { id: 16, name: 'बीस तीर्थंकर पूजा (दीप अढ़ाई मेरु)', sanskrit: 'Bees Tirthankar Puja' },
  { id: 17, name: 'सम्मेदशिखर पूजा', sanskrit: 'Sammed Shikhar Pooja' },
  { id: 18, name: 'सम्यकचारित्र पूजा', sanskrit: 'Samyak Charitra Pooja' },
  { id: 19, name: 'सम्यग्ज्ञान पूजा', sanskrit: 'SAMYAK GYAN POOJA' },
  { id: 20, name: 'सम्यग्दर्शन पूजा', sanskrit: 'SAMYAK DARSHAN POOJA' },
  { id: 21, name: 'दस लक्षण पूजा', sanskrit: 'Jain Das Lakshan Pooja' },
  { id: 22, name: 'पंच मेरु पूजा', sanskrit: 'Panch Meru Pooja' },
  { id: 23, name: 'सोलह कारण पूजा', sanskrit: 'Solah Karan Pooja' },
        ...
        {filteredTirthankaras.length > 0 ? (
          filteredTirthankaras.map((tirthankara) => (
            ...
            >
              ...
              <div>
                <h3 className="font-semibold text-blue-700">{tirthankara.name}</h3>
                <p className="text-gray-700">{tirthankara.sanskrit}</p>
              </div>
            </div>
          ))
        ) : (
