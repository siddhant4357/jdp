...
const tirthankaras = [
  { id: 1, name: 'AARTI', sanskrit: 'आरती', link: '/aarti' },
  { id: 2, name: '24-TIRTHANKAR NAME', sanskrit: '२४ तीर्थंकर नाम', link: '/commonpage/2' },
  { id: 3, name: 'Bhajan Bhakti', sanskrit: 'भजन भक्ति', link: '/bhajan-bhakti' },
  { id: 4, name: 'Contact Us', sanskrit: 'संपर्क करें', link: '/commonpage/4' }
];
...
const VartmanChaubisi = () => {
  ...
  const handleTirthankaraClick = (link) => {
      ...
      <main className="flex-1 overflow-y-auto pr-4 scrollbar-thin scrollbar-thumb-orange-600 scrollbar-track-gray-200">
        {tirthankaras.map((tirthankara) => (
          <div
            ...
            onClick={() => handleTirthankaraClick(tirthankara.link)}
          >
