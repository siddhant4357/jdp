...
const tirthankaras = [
  { id: 1, name: 'SHREE ADINATH JI', sanskrit: 'श्री आदिनाथ जी' },
  { id: 2, name: 'SHREE BAHAUBALI SWAMIJI', sanskrit: 'श्री बाहुबली स्वामीजी' },
  { id: 3, name: 'SHREE BHARATDEV JI', sanskrit: 'श्री भरतदेव जी' },
  { id: 4, name: 'SHREE NAMINATH JI', sanskrit: 'श्री नमिनाथ जी' },
  { id: 5, name: 'SHREE NEEMINATH JI', sanskrit: 'श्री नेमिनाथ जी' },
  { id: 6, name: 'SHREE MALLINATH JI', sanskrit: 'श्री मल्लिनाथ जी' },
  { id: 7, name: 'SHREE ARHANNATH JI', sanskrit: 'श्री अरहनाथ जी' },
  { id: 8, name: 'SHREE KUNTHUNATH JI', sanskrit: 'श्री कुंथुनाथ जी' },
  { id: 9, name: 'SHREE SHEETALNATH JI', sanskrit: 'श्री शीतलनाथ जी' },
  { id: 10, name: 'SHREE PUSHPADANT (SUVIDHINATH) JI', sanskrit: 'श्री पुष्पदंत (सुविधिनाथ) जी' },
  { id: 11, name: 'SHREE VASUPUJYA NATHJI', sanskrit: 'श्री वासुपूज्य नाथजी' },
  { id: 12, name: 'SHREE SIDDHACHAKRA JI', sanskrit: 'श्री सिद्धचक्र जी' },
  { id: 13, name: 'PANCHA PARAMESHTHI JI', sanskrit: 'पंच परमेष्ठी जी' },
  { id: 14, name: 'SHREE MAHAVIR SWAMI JI', sanskrit: 'श्री महावीर स्वामी जी' },
  { id: 15, name: 'SHREE PARSHWANATH SWAMI JI', sanskrit: 'श्री पार्श्वनाथ स्वामी जी' },
  { id: 16, name: 'SHREE SHANTINATH JI', sanskrit: 'श्री शांतिनाथ जी' },
  { id: 17, name: 'SHREE JINVANI MATA JI', sanskrit: 'श्री जिनवाणी माता जी' }
];
