...
const tirthankaras = [
  { id: 1, name: 'SHREE RISHABHADEV (ADINATH)', sanskrit: 'श्री ऋषभदेव ( आदिनाथ )' },
  { id: 2, name: 'SHREE AJIT NATHJI', sanskrit: 'श्री अजीतनाथजी' },
  { id: 3, name: 'SHREE SAMBHAV NATHJI', sanskrit: 'श्री संभवनाथजी' },
  { id: 4, name: 'SHREE ABHINANDAN NATHJI', sanskrit: 'श्री अभिनंदननाथजी' },
  { id: 5, name: 'SHREE SUMTI NATHJI', sanskrit: 'श्री सुमतिनाथजी' },
  { id: 6, name: 'SHREE PADMA PRABHUJI', sanskrit: 'श्री पद्मप्रभुजी' },
  { id: 7, name: 'SHREE SUPARSHVA NATHJI', sanskrit: 'श्री सुपार्श्वनाथजी' },
  { id: 8, name: 'SHREE CHANDRA PRAJBHUJI', sanskrit: 'श्री चंद्रप्रभुजी' },
  { id: 9, name: 'SHREE PUSHPADANT NATHJI', sanskrit: 'श्री पुष्पदंतनाथजी' },
  { id: 10, name: 'SHREE SHITAL NATHJI', sanskrit: 'श्री शीतलनाथजी' },
  { id: 11, name: 'SHREE SHREYANSH NATHJI', sanskrit: 'श्री श्रेयान्सनाथजी' },
  { id: 12, name: 'SHREE VASUPUJYA NATHJI', sanskrit: 'श्री वासुपूज्यनाथजी' },
  { id: 13, name: 'SHREE VIMAL NATHJI', sanskrit: 'श्री विमलनाथजी' },
  { id: 14, name: 'SHREE ANANT NATHJI', sanskrit: 'श्री अनंतनाथजी' },
  { id: 15, name: 'SHREE DHARM NATHJI', sanskrit: 'श्री धर्मनाथजी' },
  { id: 16, name: 'SHREE SHANTI NATHJI', sanskrit: 'श्री शान्तिनाथजी' },
  { id: 17, name: 'SHREE KUNTU NATHJI', sanskrit: 'श्री कुंथुनाथजी' },
  { id: 18, name: 'SHREE ARAH NATHJI', sanskrit: 'श्री अरनाथजी' },
  { id: 19, name: 'SHREE MALLI NATHJI', sanskrit: 'श्री मल्लिनाथजी' },
  { id: 20, name: 'SHREE MUNI SUVRAT NATHJI', sanskrit: 'श्री मुनिसुव्रतनाथजी' },
  { id: 21, name: 'SHREE NAMI NATHJI', sanskrit: 'श्री नमिनाथजी' },
  { id: 22, name: 'SHREE NEMI NATHJI', sanskrit: 'श्री नेमिनाथजी' },
  { id: 23, name: 'SHREE PARSHWA NATHJI', sanskrit: 'श्री पार्श्वनाथजी' },
  { id: 24, name: 'SHREE MAHAVIR SWAMIJI', sanskrit: 'श्री महावीर स्वामीजी' }
];
