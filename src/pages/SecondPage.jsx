...
const tirthankaras = [
  { id: 1, name: 'BHAGTAMAR STOTRA', sanskrit: 'भक्तामर स्त्रोत' },
  { id: 2, name: 'BHAGTAMAR STOTRA HINDI', sanskrit: 'भक्तामर स्त्रोत हिन्दी ' }, 
  { id: 3, name: 'MAHAVIRASHTAK STOTRA', sanskrit: 'महाविराष्टक स्त्रोत' },
  { id: 4, name: 'PARSHWANATH STOTRA', sanskrit: 'पार्श्वनाथ स्तोत्रं' },
  { id: 5, name: 'SHRI MANGALASHTAK STOTRA', sanskrit: 'श्री मंगलाष्टक स्त्रोत' },
  { id: 6, name: 'BARAH BHAVNA', sanskrit: 'बारह भावना' },
  { id: 7, name: 'MERI BHAVNA', sanskrit: 'मेरी-भावना' },
  { id: 8, name: 'SAMADHI BHAVNA', sanskrit: 'समाधि-भावना' },
